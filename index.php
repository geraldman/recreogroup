    ...
    <body>
        ...
        <div class="quote-section body-margin">
            <div class="accessory-background paperclip">
                <img src="img/background/paperclip-background.png" alt="" srcset="">
            </div>
            ...
            <div class="accessory-background pink-bear">
                <img src="img/background/pink-bear-background.png" alt="" srcset="">
            </div>
        </div>
        <div class="our-goals body-margin">
            <div class="h2-wrap">
                <div class="h2-inline-wrap">
                    <div class="accessory-background crown">
                        <img class="accessory" src="img/background/crown-background.png" alt="">
                    </div>
            ...
            <div class="wrap-our-goals">
                ...
                <div class="accessory-background star2">
                    <img class="accessory" src="img/background/star2-background.png" alt="">
                </div>
                ...
                <div class="accessory-background star">
                    <img class="accessory" src="img/background/star-background.png" alt="">
                </div>  
            </div>
        </div>
        <div class="crafts-tutorial body-margin">
            <div class="accessory-background flower">
                <img class="accessory" src="img/background/flower-background.png" alt="">
            </div>
            <div class="h2-wrap">
                <div class="h2-inline-wrap">
                    <div class="accessory-background leaf">
                        <img class="accessory" src="img/background/leaf-background.png" alt="">
                    </div>
            ...
            <div class="box-container">
                ...
                <div class="box-frame">
                    ...
                    <div class="box-image-frame">
                        <img src="img/craft-picture-2.png" alt="">
                        <div class="box-image-overlay">
                            <a href="#" class="overlay-text">Lihat lebih lanjut</a>
                        </div>
                    </div>
        ...
        <div class="feedback body-margin">
            <div class="accessory-background star3">
                <img src="img/background/star3-background.png" alt="" srcset="">
            </div>
            <div class="accessory-background banner">
                <img src="img/background/banner-background.png" alt="" srcset="">
            </div>
            <div class="accessory-background puzzle">
                <img src="img/background/puzzle-background.png" alt="" srcset="">
            </div>
